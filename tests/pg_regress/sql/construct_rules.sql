...
-- Reuses existing predicates (cwb.test/knows → cwb.test/ivm02derived) to avoid
-- introducing new predicates that would shift VP table sequence numbers.
...
-- Insert a triple using the existing predicate (already in dictionary)
SELECT pg_ripple.insert_triple(
    '<https://cwb.test/IVM02A>',
    '<https://cwb.test/knows>',
    '<https://cwb.test/IVM02B>',
    '<https://cwb.test/source>'
