...
| R2RML-DOC-01 | Document `src/r2rml.rs` scope as materialization-only; create `plans/r2rml-virtual.md` tracking item | Required |
...
2. Create `plans/r2rml-virtual.md` tracking a future virtual R2RML layer (read-time mapping without materialization).
