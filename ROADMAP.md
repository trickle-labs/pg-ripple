...
### Dependency Maintenance (v0.112.0)
...
v0.111.0       │── NS-RL PPRL (needs v0.110.0): bloom_encode() CLK, pg:dice_similarity,
       ...
       │
v0.112.0       ─── Dependency maintenance: pg_trickle 0.57.0 bump,
               │   .versions.toml + Dockerfile update, compatibility matrix row
       │
v0.113.0       ─── Assessment 16 critical & high remediation: COMPATIBLE_EXTENSION_MIN
               │   bump to 0.112.0 + CI release gate (C16-01 CLOSED);
       ...
       │
v0.114.0       ─── A16 performance high: bulk_load COPY FROM STDIN BINARY path
       ...
       │
v0.115.0       ─── A16 medium: module splits — views/mod.rs 1,599 LOC → 5 files;
       ...
       │
v0.116.0       ─── A16 medium: HTTP API parity — temporal/pprl/dp/entity-resolution/
       ...
       │
v0.117.0       ─── A16 medium: correctness & GUC hygiene — er_monitoring retention GUC
       ...
       │
v0.118.0       ─── A16 low-severity polish: #[allow] reduction (-10%); crash_recovery
       ...
       │
v0.119.0       ─── New features: Allen's 7 interval-relation SPARQL FILTERs (before/
       ...
       │
v0.120.0       ─── New features: owl:propertyChainAxiom inference + 10 canonical tests;
       ...
       │
v0.121.0       ─── New features: GET /pagerank/explain/{node} HTTP endpoint;
